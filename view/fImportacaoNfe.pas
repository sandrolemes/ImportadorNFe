...
begin
  ...
  qryEventos.SQL.Add('  DT_EVENTO,');
  qryEventos.SQL.Add('  TIPO_EVENTO,');
  qryEventos.SQL.Add('  STATUS_ANTES,');
  qryEventos.SQL.Add('  STATUS_DEPOIS,');
  qryEventos.SQL.Add('  MENSAGEM');
  qryEventos.SQL.Add('FROM DOCUMENTO_EVENTO');
  qryEventos.SQL.Add('WHERE ID_DOCUMENTO = :ID_DOCUMENTO');
